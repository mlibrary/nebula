      ...
      describe 'concat_fragments' do
        ...
        context 'for first-instance' do
...

          {
            ...
            'infrastructure.db.url'             => '{"infrastructure": {"db": {"url": "TODO"}}}',
            'infrastructure.db.adapter'         => '{"infrastructure": {"db": {"adapter": "TODO"}}}',
            'infrastructure.db.username'        => '{"infrastructure": {"db": {"username": "TODO"}}}',
            'infrastructure.db.password'        => '{"infrastructure": {"db": {"password": "TODO"}}}',
            'infrastructure.db.host'            => '{"infrastructure": {"db": {"host": "TODO"}}}',
            'infrastructure.db.port'            => '{"infrastructure": {"db": {"port": "TODO"}}}',
            'infrastructure.db.database'        => '{"infrastructure": {"db": {"database": "TODO"}}}',
            'infrastructure.base_dir'           => '{"infrastructure": {"base_dir": "TODO"}}',
            'infrastructure.bind'               => '{"infrastructure": {"bind": "TODO"}}',
            'infrastructure.relative_url_root'  => '{"infrastructure": {"relative_url_root": "TODO"}}',
            'infrastructure.redis.1'            => '{"infrastructure": {"redis": {"1": "TODO"}}}',
            'infrastructure.solr.1'             => '{"infrastructure": {"solr": {"1": "TODO"}}}',
