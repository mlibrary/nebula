...
describe 'nebula::profile::hathitrust::lss' do
  on_supported_os.each do |os, os_facts|
    context "on #{os}" do
      ...
      it { is_expected.to contain_file('/s0lr/h0me/66').with(ensure: 'link', target: '/htsolr/serve/lss-66') }
      it { is_expected.to contain_file('/s0lr/h0me/99').with(ensure: 'link', target: '/htsolr/serve/lss-99') }
      it { is_expected.to contain_file('/s0lr/h0me/lib').with(ensure: 'link', target: '/htsolr/serve/lss-shared/lib') }
