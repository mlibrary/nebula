    ...
    context "on #{os}" do
      ...
      context 'with nothing but the title "vmname"' do
        ...
        [
          ...
          %r{^d-i apt-setup/local0/repository string https://apt\.lib\.umich\.edu bullseye main$.*^d-i apt-setup/local0/key string https://apt\.lib\.umich\.edu/mlibrary-archive-keyring\.asc$}m,
